   ...
   <div class="position_content" id="page_position_content">
    ...
    <!-- Formulaire d'envoi -->
      ...
      <ul class="AccordionWidget clearfix" id="accordionu6237"><!-- column -->
       ...
       <p>&nbsp;&nbsp;&nbsp; SUPPRISSION DES  FORMATIONS</p>
       </div>
           ...
           <?php
                ...
                if(isset($_GET['id']) && is_numeric($_GET['id'])) {
                        ...
                        echo '<ul><li>La formation est bien  supprimé !</li></ul>';
                }
        ...
        if($nbEvents) {
                ...
                while($evenement = mysql_fetch_array($evenements)) {
                        ...
                        <table class="listeEvent">
                                ...
                                <tr><td>'.html_entity_decode($evenement['option']).'</td></tr>
                ...
                echo '<p>Il n\'y a pas de formation à supprimer</p>';
...
<p class="centre"><a href="../form_formation.php">Revenir à l'accueil</a></p>
     </div>
    </div>
    </div>
    </div>
