   	...
   	<div class="position_content" id="page_position_content">
    		...
    		<div class="clearfix colelem" id="pu10565"><!-- group -->
     			<div class="clearfix grpelem" id="u10565"><!-- column -->
      			...
      			<div class="clearfix colelem" id="u14594-4"><!-- content -->
        				<nav class="MenuBar clearfix colelem" id="admin1">
         				<div class="MenuItemContainer clearfix colelem" id="admin2">
        						<a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive rounded-corners clearfix grpelem" id="admin3" href="admin/ajoutevent.php"><!-- horizontal box --><div class="MenuItemLabel clearfix grpelem" id="admin4"><!-- content --><p>&nbsp;&nbsp; Ajouter une formation</p></div></a>
        					</div>
        				</nav>
        				<br/><br/>
        				<nav class="MenuBar clearfix colelem" id="admin1">
         				<div class="MenuItemContainer clearfix colelem" id="admin2">
        						<a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive rounded-corners clearfix grpelem" id="admin3" href="admin/supprevent.php"><!-- horizontal box --><div class="MenuItemLabel clearfix grpelem" id="admin4"><!-- content --><p>&nbsp;&nbsp; Supprimer une formation</p></div></a>
 							</div>   
 						</nav>					
    					<br/><br/> 
						<nav class="MenuBar clearfix colelem" id="admin1">
         				<div class="MenuItemContainer clearfix colelem" id="admin2">
        						<a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive rounded-corners clearfix grpelem" id="admin3" href="index.php"><!-- horizontal box --><div class="MenuItemLabel clearfix grpelem" id="admin4"><!-- content --><p>&nbsp;&nbsp; Revenir à la page d'accueil</p></div></a>
							</div>
						</nav>
               </div>
               </div>
